    ...
    return (
        <div class="space-y-4">
                ...
                <For each={methods()}>
                    {(m) => (
                        <button
                            ...
                            class={`flex-1 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${activeTab() === m.id ? 'bg-white/10 text-white shadow-sm ring-1 ring-white/20' : 'text-muted-foreground hover:text-white'
                                }`}
                        >
                            {m.label}
                        </button>
            ...
            <div class="grid grid-cols-2 gap-3 mt-4">
                <button class="flex items-center justify-center gap-2 p-3 rounded-xl glass hover:bg-white/10 transition-all text-sm text-muted-foreground hover:text-white border border-white/5">
